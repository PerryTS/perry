// Maximally faithful reproduction of @redis/client's RedisClient shape:
// SAME 22 module-scope free-variable names (in the SAME declaration order)
// as the real dist/lib/client/index.js, extending a NATIVE base
// (node:events EventEmitter), constructed through an indirect dynamic
// subclass (`_a.extend()` factory), with the SAME double-reference
// `??`-with-private-method-fallback statement inside an `async connect()`.
"use strict";

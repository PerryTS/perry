...
{"protoIdentity":true,"protoKeys":["inherited"],"forInKeys":["own","inherited"],"keys":["own"],"spread":{"own":1},"assign":{"own":1},"ctorIsObject":true}
EOF_EXPECTED
...
echo "PASS: Object.create for-in prototype chain"

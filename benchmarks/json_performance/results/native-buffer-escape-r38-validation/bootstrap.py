...
w=Path(__file__).resolve().parent;root=w.parents[3];old=w.with_name('specialized-json-token-length-r37');sha=lambda p:hashlib.sha256(p.read_bytes()).hexdigest()
head=subprocess.check_output(['git','rev-parse','HEAD'],cwd=root,text=True).strip()
assert head=='5f6448ce7b38754481ab020f2f6d059c40dac0d2'
...
def copy(p,d,adapt=False):
 ...
 if adapt:
  d.write_text(p.read_text().replace('specialized-json-token-length-r37','native-buffer-escape-r38').replace('SPECIALIZED_JSON_TOKEN_LENGTH_R37','NATIVE_BUFFER_ESCAPE_R38').replace('R37','R38').replace("'r37'","'r38'").replace('json-r37-','json-r38-').replace('3d59ed5219ace6bf001df3de9108c52434dc4232','5f6448ce7b38754481ab020f2f6d059c40dac0d2'))
...
(w/'base.json').write_text(json.dumps(dict(base_commit='a510f0fcb7c38670d82b10f3f074a4b66b1aef4d',reference_name='R26',branch_parent_source=head,previous_candidate_source='3d59ed5219ace6bf001df3de9108c52434dc4232'),indent=2)+'\n')
(w/'main-reuse-provenance.json').write_text(json.dumps(dict(source_commit='3aac4d6335da54abeeed73df842decbbe6dd5d71',reference_evidence_commit='a510f0fcb7c38670d82b10f3f074a4b66b1aef4d',copy_via_r37_evidence='04731562c57bb670e903f9680ad33d7bcf10f728',note='Exact frozen R26 reference copied through R37. Reuse81original plus20emitter plus4primitive reference executions and28IR only with source/fixture equivalence. Primitive native finding is preserved unsuppressed; shadowchecks pass. All candidate executions will be fresh. No current-main or R37-candidate reference.',files=records),indent=2)+'\n')

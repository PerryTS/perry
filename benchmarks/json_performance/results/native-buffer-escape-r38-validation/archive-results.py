...
assert kind in ['access','focus','options','full','rotating','retained'] and slug.startswith('quiet-'+w.name+'-') and (slug.endswith('-'+kind) or (kind == 'rotating' and slug == 'quiet-native-buffer-escape-r38-rotating-retry1'))

...
original=original_root/'benchmarks/json_performance/.work/native-buffer-escape-r38'
...
for n in ['build-release.py','validate-and-build.py','run-lint.py']:
 ...
 copy(original/n,p)
for name in ['initial-a23-unit-compile','initial-b880-interrupted']:

...
drivers={'rotating':['run_rotating.py','with_lock.py','rotating-worker.js','rotating-worker.ts'], 'original':['run_baseline.py','with_lock.py','worker.js','worker.ts'], 'focus':['run_regression_focus_r5.py','run_dispatch_focus.py','with_lock.py','worker.js','worker.ts']}[kind]

...
assert expected[prefix+'r26-rotating-worker']==next(h for p,h in reference['files'].items() if p=='benchmarks/json_performance/.work/trusted-materialized-read-r26/candidate-rotating-worker')

...
print('R35 candidate validation complete: 81 existing cases plus 20 fresh emitter executions plus four primitive-key checks per arm, 28 matching IR files and six worker objects.',flush=True)

...
original=original_root/'benchmarks/json_performance/.work/isolated-json-scan-chunks-r36'
...
for n in ['build-release.py','validate-and-build.py','run-lint.py']:
 ...
 copy(original/n,p)
for name in ['initial-3f5-validation','initial-9f7-validation','lint-before-final-source-commit']:

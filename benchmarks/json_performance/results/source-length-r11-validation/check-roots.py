...
sources=[w/(stem+'.ts') for stem in ['test_json_source_length','prior-entry','callback-only','options-worker']]+[w/'harness'/(stem+'.ts') for stem in ['worker','access-worker']];results=[]

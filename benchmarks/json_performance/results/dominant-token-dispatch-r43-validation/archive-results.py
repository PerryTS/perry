...
assert kind in ['access','focus','options','full','rotating','retained'] and slug.startswith('quiet-'+w.name+'-') and (slug.endswith('-'+kind) or (kind == 'rotating' and slug == 'quiet-dominant-token-dispatch-r43-rotating-retry1') or (kind == 'full' and slug == 'quiet-dominant-token-dispatch-r43-full-retry1'))

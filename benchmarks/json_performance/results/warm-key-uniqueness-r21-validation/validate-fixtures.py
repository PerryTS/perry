...
subjects=['lazy-spacer'] if '--lazy-only' in sys.argv else ['test_json_source_length','test_json_template_capture','test_json_cached_construction','test_json_warm_unique_keys','prior-entry','callback-only']

...
for name in ['perry','libperry_runtime.a','libperry_stdlib.a']:
 ...
 if name == 'libperry_runtime.a':
  assert source.read_bytes().replace(commit.encode(),b'24a8ab6953ba811f5112e49ba1c79ae6e683118b')==(previous/name).read_bytes(), 'runtime changes beyond commit stamp'
...
meta={'archive_reference_commit':'24a8ab6953ba811f5112e49ba1c79ae6e683118b','archive_policy':'All artifacts fresh; runtime must equal R5 except embedded commit stamp. No stdlib equality claim.','source_commit':commit,'command':command,'started_utc':datetime.datetime.fromtimestamp(started,datetime.timezone.utc).isoformat(),'elapsed_seconds':time.time()-started,'files':files}

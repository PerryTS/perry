    ...
    for fixture in fixtures:
        ...
        if args.phase in {'all', 'timing'}:
            for mode in modes:
                ...
                assert fixture['fixture'] == 'small_record' and mode in {'rotating': 2321080, 'same': 6217616}
                count = {'rotating': 2321080, 'same': 6217616}[mode]  # Four times the archived initial work.

...
original=original_root/'benchmarks/json_performance/.work/stringify-emitter-flags-r30'
...
for n in ['build-provenance.json','build-start.json','build-command-result.json','unit-source.json','unit.log','build.log','validate-and-build.log','lint-results.json','script-lint.log','file-cap.log','worktree-provenance.json','lint-review.json','string-suite.log','string-suite-provenance.json']:
 copy(original/n,w/n)

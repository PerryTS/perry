...
w=Path(__file__).resolve().parent;root=w.parents[3];old=w.with_name('stringify-key-snapshot-r29');sha=lambda p:hashlib.sha256(p.read_bytes()).hexdigest()
head=subprocess.check_output(['git','rev-parse','HEAD'],cwd=root,text=True).strip()
assert head=='3c14d729947343431cc98e18fd78a3f06cd5f538'
...
(w/'base.json').write_text(json.dumps(dict(base_commit=base,reference_name='R26',branch_parent_source=head,previous_candidate_source='f4d4ee8735f53700ac03320e8a33c273ca3c97e2'),indent=2)+'\n')

...
assert json.loads((w/'provenance.json').read_text())['source_commit']=='e69d1292110cf9abee24f8690c584652805a4167'
...
token='json-r39-korean-stage-'+str(os.getpid())
...
cmd=['python3','with_lock.py','--','python3',prefix+'run-korean-rotating.py','--worker',prefix+'candidate-rotating-worker','--baseline-worker',prefix+'main-rotating-worker','--node','/opt/homebrew/bin/node','--bun','/Users/perry/.bun/bin/bun','--repeat','7','--source-commit','e69d1292110cf9abee24f8690c584652805a4167','--results-dir','results/'+slug]

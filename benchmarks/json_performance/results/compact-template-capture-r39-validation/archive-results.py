...
assert kind in ['access','focus','options','full','rotating','retained'] and slug.startswith('quiet-'+w.name+'-') and (slug.endswith('-'+kind) or (kind == 'rotating' and slug == 'quiet-compact-template-capture-r39-rotating-retry1'))

    ...
    for fixture in fixtures:
        ...
        if args.phase in {'all', 'timing'}:
            for mode in modes:
                ...
                assert fixture['fixture'] == 'small_record' and mode in {'rotating': 2325580, 'same': 6818180}
                count = {'rotating': 2325580, 'same': 6818180}[mode]  # Four times the archived initial work.

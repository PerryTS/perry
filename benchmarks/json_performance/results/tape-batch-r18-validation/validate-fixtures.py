...
subjects=['lazy-spacer'] if '--lazy-only' in sys.argv else ['test_json_source_length','test_json_template_capture','test_json_tape_batch_records','prior-entry','callback-only']

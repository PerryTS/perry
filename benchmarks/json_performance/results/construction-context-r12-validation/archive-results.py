...
assert kind in ['access','focus','options','full','rotating'] and slug in ['quiet-'+w.name+'-'+kind, 'quiet-'+w.name+'-recheck-'+kind]
code="""from pathlib import Path
import json,shutil
root=Path(REMOTE);w=root/'.work'/'construction-context-r12';d=root/'results'/SLUG

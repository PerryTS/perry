...
engines={'perry':[str(Path(a.worker).resolve())],'baseline':[str(Path(a.baseline_worker).resolve())],'node':[a.node,str(work/'short-loops.js')],'bun':[a.bun,str(work/'short-loops.js')]}

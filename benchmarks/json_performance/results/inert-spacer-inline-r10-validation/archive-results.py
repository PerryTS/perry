...
assert kind in ['access','focus','options','full'] and slug in ['quiet-'+w.name+'-'+kind, 'quiet-'+w.name+'-recheck-'+kind]
code="""from pathlib import Path
import json,shutil
root=Path(REMOTE);w=root/'.work'/'inert-spacer-inline-r10';d=root/'results'/SLUG

...
assert json.loads((w/'candidate-controller-result.json').read_text())['exit_code']==0
...
expected={p:hashlib.sha256((bench/p).read_bytes()).hexdigest() for p in files};token='json-r40-stage-'+str(os.getpid())

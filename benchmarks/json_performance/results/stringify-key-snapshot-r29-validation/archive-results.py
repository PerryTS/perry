...
for name in ['main-emitter-validation.json','candidate-emitter-validation.json','main-emitter-roots.json','candidate-emitter-roots.json','emitter-comparison.json','build-copy-provenance.json']:shutil.copy2(w/name,d/name)

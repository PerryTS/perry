...
files += [str((w/'build-copy-provenance.json').relative_to(bench))]
expected={p:hashlib.sha256((bench/p).read_bytes()).hexdigest() for p in files};token='json-r29-stage-'+str(os.getpid())

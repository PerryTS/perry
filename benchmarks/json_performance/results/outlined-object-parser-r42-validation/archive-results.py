...
assert kind in ['access','focus','options','full','rotating','retained'] and slug.startswith('quiet-'+w.name+'-') and (slug.endswith('-'+kind) or (kind == 'rotating' and slug == 'quiet-outlined-object-parser-r42-rotating-retry1') or (kind == 'full' and slug == 'quiet-outlined-object-parser-r42-full-retry1'))

...
if '--write' in sys.argv:
 ...
 paths=[bench/'OUTLINED_OBJECT_PARSER_R42.md']+[p for folder in [d,validation] for p in sorted(folder.rglob('*')) if p.is_file()]

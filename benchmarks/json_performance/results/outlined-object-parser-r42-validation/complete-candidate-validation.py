...
print('R42 candidate validation complete: 81 existing cases plus 20 emitter executions, four primitive-key and 20 large-emitter candidate checks, 30 matching IR files and six worker objects.',flush=True)

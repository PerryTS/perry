...
for kind in phases:
    ...
    assert len(timings) == 396 and len(verifies) == 45 and len(summary) == 36
    ...
    assert len(by_case) == {'access': 12, 'focus': 9, 'options': 4 if recheck else 7, 'full': 5 if full_recheck else 50}[kind]

...
assert kind in ['access','focus','options','full','rotating','retained'] and slug.startswith('quiet-'+w.name+'-') and (slug.endswith('-'+kind) or (kind == 'rotating' and slug == 'quiet-packed-vector-escape-r41-rotating-retry1'))

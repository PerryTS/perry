...
assert not (w/'archive').exists(), 'Preserve the previous terminal archive and select a new remote slug before any repeat.'
...
slug='quiet-'+w.name+'-retry1';cmd=['python3','with_lock.py','--','python3',prefix+'run-parse-regression-profile.py','--results-dir','results/'+slug]

...
assert json.loads((w/'provenance.json').read_text())['source_commit']=='3952e832058a5e1efcd4cdf9cf28f26e31d60ea3'
...
token='json-r41-korean-stage-'+str(os.getpid())
...
cmd=['python3','with_lock.py','--','python3',prefix+'run-korean-rotating.py','--worker',prefix+'candidate-rotating-worker','--baseline-worker',prefix+'main-rotating-worker','--node','/opt/homebrew/bin/node','--bun','/Users/perry/.bun/bin/bun','--repeat','7','--source-commit','3952e832058a5e1efcd4cdf9cf28f26e31d60ea3','--results-dir','results/'+slug]

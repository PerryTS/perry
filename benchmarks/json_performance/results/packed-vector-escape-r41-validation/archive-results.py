...
assert kind in ['access','focus','options','full','rotating','retained'] and slug.startswith('quiet-'+w.name+'-') and (slug.endswith('-'+kind) or (kind == 'rotating' and slug == 'quiet-packed-vector-escape-r41-rotating-retry1') or (kind == 'full' and slug == 'quiet-packed-vector-escape-r41-full-retry1'))
...
for name in ['main-emitter-validation.json','candidate-emitter-validation.json','main-emitter-roots.json','candidate-emitter-roots.json','emitter-comparison.json','build-copy-provenance.json','string-suite-provenance.json']:shutil.copy2(w/name,d/name)
for name in ['main-primitive-keys-validation.json','candidate-primitive-keys-validation.json','main-primitive-keys-roots.json','candidate-primitive-keys-roots.json','primitive-keys-comparison.json']:shutil.copy2(w/name,d/name)
for name in ['main-large-emitter-validation.json','candidate-large-emitter-validation.json','main-large-emitter-roots.json','candidate-large-emitter-roots.json','large-emitter-comparison.json']:shutil.copy2(w/name,d/name)

...
lines += ['', '“Separated” means the smallest candidate sample exceeds the largest reference sample. It is a descriptive screen, not a significance test. Overlapping samples do not prove equivalence. These R41 rows have not received a second independent R41 recheck.', '']

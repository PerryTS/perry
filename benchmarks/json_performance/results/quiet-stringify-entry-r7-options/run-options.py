...
CASES = [('small_record','zero',1000000,5000,7), ('small_record','pretty',200000,5000,7), ('small_record','keys',200000,5000,7), ('small_record','callback',50000,5000,7), ('records_array_16k','pretty',500,8,7)]
...
def parse_case(value):
    ...
    try:
        ...
        if (not fixture or not all(c.isascii() and (c.isalnum() or c == '_') for c in fixture)
                or operation not in {'zero', 'pretty', 'keys', 'callback'}

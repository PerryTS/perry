...
Generated from [`benchmarks/results/public-node-bun-v1.json`](benchmarks/results/public-node-bun-v1.json) at Perry commit `689b1ffbab1b`.
...
| method_calls | 34 ms | 11 ms | 8 ms | loss vs both | Class method dispatch |
...
| string_concat | 5 ms | 31 ms | 6 ms | win vs both | String append loop |
| prime_sieve | 6 ms | 5 ms | 5 ms | loss vs both | Sieve of Eratosthenes |
| mandelbrot | 25 ms | 24 ms | 29 ms | mixed | Complex-number iteration |
| matrix_multiply | 18 ms | 32 ms | 33 ms | win vs both | Matrix multiplication |
| json_roundtrip | 142 ms | 382 ms | 219 ms | win vs both | Parse and stringify ~1 MB JSON |

...
pub(crate) use self::header::{
    array_byte_size, array_has_named_properties, array_has_named_properties_resolved,
    array_is_frozen, array_is_sealed_or_no_extend, array_named_property_delete,
    ...
    refresh_array_numeric_layout, refresh_array_numeric_layout_resolved,

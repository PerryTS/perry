...
//! `globalThis.console`, etc. Also home for the codegen-emitted
//! `js_global_or_console_property_by_name` property-read shortcut.
//!
//! Split out of `object/mod.rs` (issue #1103).

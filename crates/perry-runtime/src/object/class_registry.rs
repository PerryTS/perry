...
pub(crate) use state::{
    ...
    class_dynamic_prop_root_store, class_has_dynamic_prop_in_chain, class_has_own_dynamic_prop,
    ...
    class_static_defined_attrs, class_static_set_defined_attrs, global_object_prototype_bits,

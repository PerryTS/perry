...
pub(crate) fn build_bound_method_closure(
    ...
    crate::closure::js_closure_set_capture_ptr(
        closure_handle.get_raw_mut_ptr(),
        1,
        method_name_ptr as i64,
    );
    crate::closure::js_closure_set_capture_ptr(
        closure_handle.get_raw_mut_ptr(),
        2,
        method_name_len as i64,
    );
    #[cfg(test)]
    TEST_COLLECT_BOUND_METHOD_AFTER_CAPTURE_INIT.with(|armed| {
        if armed.replace(false) {
            let before = closure_handle.get_raw_mut_ptr::<crate::closure::ClosureHeader>() as usize;
            crate::gc::gc_collect_minor();
            let after = closure_handle.get_raw_mut_ptr::<crate::closure::ClosureHeader>() as usize;
    ...
    if !method_name_ptr.is_null() && method_name_len > 0 {
        if let Ok(name) = unsafe {
            ...
            set_bound_native_closure_name(closure_handle.get_raw_mut_ptr(), name);
...
pub(crate) fn build_symbol_bound_method_closure(
    ...
    crate::closure::js_closure_set_capture_ptr(closure_handle.get_raw_mut_ptr(), 4, meta);
    ...
    crate::gc::runtime_write_barrier_root_heap_word(
        closure_handle.get_raw_mut_ptr::<crate::closure::ClosureHeader>() as u64,
    );
    crate::value::js_nanbox_pointer(
        closure_handle.get_raw_mut_ptr::<crate::closure::ClosureHeader>() as i64,
    )

...
pub use registry::{
    ...
    is_registered_generator_function, is_registered_no_this_rebind, is_registered_strict_function,
    ...
    js_register_closure_generator_function, js_register_closure_length,
    js_register_closure_no_this_rebind, js_register_closure_rest,

...
pub use registry::{
    ...
    js_register_closure_arity, js_register_closure_function_kind, js_register_closure_rest,
    js_register_closure_synthetic_arguments, lookup_closure_arity, lookup_closure_function_kind,
    lookup_closure_rest, lookup_closure_rest_full, real_capture_count, resolve_strategy,
    DispatchStrategy, BOUND_METHOD_FUNC_PTR, CAPTURES_THIS_FLAG, CLOSURE_FUNCTION_KIND_ASYNC,
    CLOSURE_FUNCTION_KIND_GENERATOR, CLOSURE_MAGIC,
};

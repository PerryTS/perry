...
pub(crate) use page_meta::{
    ...
    old_arena_page_index_remove_object, old_arena_walk_objects_on_pages,
    old_object_page_overlaps, old_page_account_dirty_slot, old_page_account_promoted_object,

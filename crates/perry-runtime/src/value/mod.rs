...
pub use tags::{
    ...
    JS_NATIVE_CRYPTO_DISPATCH, JS_NATIVE_DOMAIN_DISPATCH,
...
pub use handle::{
    ...
    js_set_native_async_hooks_construct, js_set_native_domain_dispatch,
    js_set_native_events_construct, js_set_native_http_dispatch,

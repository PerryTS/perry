...
pub(super) fn compile_module_entry(
    ...
    if is_entry {
        ...
        let mut ctx = FnCtx {
            ...
            i32_only_counter_updates: HashSet::new(),
            exact_safe_integer_locals: HashMap::new(),
            i64_loop_accumulator_slots: HashMap::new(),
            ...
            direct_method_new_locals: main_native_facts.direct_method_new_locals().clone(),
            direct_field_new_locals: main_native_facts.direct_field_new_locals().clone(),
        ...
        let mut ctx = FnCtx {
            ...
            scalar_ctor_target: Vec::new(),
            const_new_class_locals: HashMap::new(),
            direct_method_new_locals: init_native_facts.direct_method_new_locals().clone(),
            direct_field_new_locals: init_native_facts.direct_field_new_locals().clone(),
            exact_safe_integer_class_fields: HashMap::new(),

...
pub fn declare_stdlib_ffi(module: &mut LlModule) {
    ...
    module.declare_function("js_net_block_list_add_address", I64, &[I64, I64, I64]);
    module.declare_function("js_net_block_list_add_range", I64, &[I64, I64, I64, I64]);
    module.declare_function(
    ...
    module.declare_function("js_net_block_list_to_json", I64, &[I64]);

...
pub fn declare_stdlib_ffi(module: &mut LlModule) {
    ...
    // ========== Event emitter ==========
    module.declare_function("js_event_emitter_emit", DOUBLE, &[I64, DOUBLE, I64]);
    module.declare_function("js_event_emitter_emit0", DOUBLE, &[I64, DOUBLE]);
    module.declare_function(
    ...
    module.declare_function("js_event_emitter_on", I64, &[I64, DOUBLE, I64]);
    module.declare_function("js_event_emitter_once", I64, &[I64, DOUBLE, I64]);
    module.declare_function(
    ...
    module.declare_function("js_event_emitter_remove_all_listeners", I64, &[I64, DOUBLE]);
    module.declare_function("js_event_emitter_remove_listener", I64, &[I64, DOUBLE, I64]);
    ...
    module.declare_function("js_event_emitter_listeners", I64, &[I64, DOUBLE]);
    module.declare_function("js_event_emitter_raw_listeners", I64, &[I64, DOUBLE]);
    // Module-level helpers
    module.declare_function("js_events_once", I64, &[DOUBLE, DOUBLE, DOUBLE]);
    module.declare_function("js_events_on", I64, &[DOUBLE, DOUBLE, DOUBLE]);
    module.declare_function("js_events_add_abort_listener", I64, &[DOUBLE, DOUBLE]);
    module.declare_function("js_events_get_event_listeners", I64, &[DOUBLE, DOUBLE]);
    module.declare_function("js_events_listener_count", DOUBLE, &[DOUBLE, DOUBLE]);

...
pub(super) const NODE_CORE_ROWS: &[NativeModSig] = &[
    ...
    // #2135 / #3045 (Node process parity): process.loadEnvFile(path?) —
    // runtime validates the NaN-boxed path value so omitted/nullish,
    // string, Buffer, and file URL inputs share one path.
    NativeModSig {
        module: "process",
        has_receiver: false,
        method: "loadEnvFile",

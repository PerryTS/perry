...
pub(super) const NET_EVENTS_ROWS: &[NativeModSig] = &[
    ...
    NativeModSig {
        ...
        method: "setMaxListeners",
        class_filter: None,
        runtime: "js_event_emitter_set_max_listeners_raw",
        args: &[NA_JSV],
        ret: NR_PTR,
    },
    NativeModSig {
    ...
    NativeModSig {
        ...
        class_filter: None,
        runtime: "js_events_get_event_listeners_raw",
        args: &[NA_JSV, NA_STR],
        ret: NR_PTR,
    },
    NativeModSig {
        ...
        method: "listenerCount",
        class_filter: None,
        runtime: "js_events_listener_count_raw",
        args: &[NA_JSV, NA_STR],
        ret: NR_F64,
    },
    NativeModSig {
        ...
        method: "getMaxListeners",
        class_filter: None,
        runtime: "js_events_get_max_listeners_raw",
        args: &[NA_JSV],
        ret: NR_F64,
    },
    NativeModSig {
        ...
        method: "setMaxListeners",
        class_filter: None,
        runtime: "js_events_set_max_listeners_raw",
        args: &[NA_JSV, NA_VARARGS],
        ret: NR_F64,
    },
    NativeModSig {

...
// #5994 (revert follow-up): relocated from new.rs to keep it under the
// 2000-line gate — self-contained ctor-arity / new.target / symbol-existence
// predicates that #5874's split had also moved out.

...
const FFI_REGISTRY: &[(&str, OwnerKind)] = &[
    ...
    // #2210 — server option getters / setters.
    ("js_node_http_server_get_headers_timeout",     OwnerKind::WellKnown("http")),
    ("js_node_http_server_set_headers_timeout",     OwnerKind::WellKnown("http")),
    ("js_node_http_server_get_keep_alive_timeout",  OwnerKind::WellKnown("http")),
    ("js_node_http_server_set_keep_alive_timeout",  OwnerKind::WellKnown("http")),
    ("js_node_http_server_get_request_timeout",     OwnerKind::WellKnown("http")),
    ("js_node_http_server_set_request_timeout",     OwnerKind::WellKnown("http")),
    ("js_node_http_server_get_timeout",             OwnerKind::WellKnown("http")),
    ("js_node_http_server_set_timeout",             OwnerKind::WellKnown("http")),
    ("js_node_http_server_get_max_headers_count",   OwnerKind::WellKnown("http")),
    ("js_node_http_server_set_max_headers_count",   OwnerKind::WellKnown("http")),
    ("js_node_http_server_get_max_requests_per_socket", OwnerKind::WellKnown("http")),
    ("js_node_http_server_set_max_requests_per_socket", OwnerKind::WellKnown("http")),
    ("js_node_http_server_get_keep_alive_initial_delay", OwnerKind::WellKnown("http")),
    ("js_node_http_server_set_keep_alive_initial_delay", OwnerKind::WellKnown("http")),
    ("js_node_http_server_get_no_delay",            OwnerKind::WellKnown("http")),
    ("js_node_http_server_set_no_delay",            OwnerKind::WellKnown("http")),
    ("js_node_http_server_get_keep_alive",          OwnerKind::WellKnown("http")),
    ("js_node_http_server_set_keep_alive",          OwnerKind::WellKnown("http")),

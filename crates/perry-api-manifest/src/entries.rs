...
pub static API_MANIFEST: &[ApiEntry] = &[
    ...
    class("crypto", "ECDH"),
    // #1367: crypto.X509Certificate — exposed as a constructor so
    // `typeof crypto.X509Certificate === "function"` and the strict-API
    // gate allows the read. Full cert parsing is tracked separately.
    ...
    // #1343: method values addressable via call-form HIR variants.
    ...
    // #1372: process is an EventEmitter.

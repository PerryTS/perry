    ...
    rt: {
      ...
      class_call_method: (handle, methodNameId, argsHandle) => {
        ...
        const uiMethodMap = {
          ...
          setMaxWidth: "perry_ui_widget_set_max_width",
...
function perry_ui_widget_set_max_width(h, w) { const el = uiGet(h); if (el) { el.style.width = "100%"; el.style.maxWidth = w + "px"; el.style.marginLeft = "auto"; el.style.marginRight = "auto"; } }
...
const __perryUiDispatch = {
  ...
  perry_ui_widget_set_width, perry_ui_widget_set_max_width, perry_ui_widget_set_height, perry_ui_widget_set_hugging,

...
// ---- decl.rs ----
pub use decl::{
    ArgumentsObjectMeta, Class, ClassField, Decorator, Enum, EnumMember, EnumValue, Export,
    Function, Global, Import, ImportSpecifier, Interface, InterfaceMethod, InterfaceProperty,
    Param, TypeAlias,
};

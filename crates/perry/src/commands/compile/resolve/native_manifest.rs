...
pub(in crate::commands::compile) fn parse_native_library_manifest(
    package_dir: &Path,
    module_name: &str,
    target: Option<&str>,
...
pub(super) fn parse_native_library_functions(
    package_json: &Path,
...
pub(super) fn parse_target_native_config(
    package_dir: &Path,
    module_name: &str,
    target_key: &str,
    manifest_path: &str,
...
/// the v0.5.x cycle.
pub(super) const PERRY_FFI_ABI_VERSION: &str = env!("CARGO_PKG_VERSION");
...
pub(in crate::commands::compile) fn validate_abi_version(

...
#[test]
fn define_property_array_prototype_setter_intercepts_in_bounds_numeric_hole() {
    compile_and_run(
        r#"
...
values[1] = 42;
console.log(hits, values.length, values[1], Object.prototype.hasOwnProperty.call(values, 1));
"#,
        "1 3 P false\n",
        "in_bounds_hole",
    );

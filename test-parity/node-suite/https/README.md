...
| `request/agent-false.ts`                       | `agent: false` still performs trusted HTTPS                   | `lib/https.js` `request`; Bun `test-https-should-work-when-sending-request-with-agent-false.ts` |

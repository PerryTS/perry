...
and hostname identity, positional/context-backed/preconnected loopback
handshakes, mutual authentication, missing-certificate and plaintext rejection,
event cleanup, socket getters, `setKeyCert`, shared signature algorithms and
certificate views, finished-message/exporter material, ALPN callback/protocol
selection, case-insensitive wildcard SNI and latest-`addContext` selection, TLS
1.2 session resumption, ticket keys, and fragment-size controls.
